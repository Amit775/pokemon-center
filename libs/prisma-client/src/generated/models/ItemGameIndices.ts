...
// @ts-nocheck 
/*
 * This file exports the `ItemGameIndices` model and its related types.
 *
...
export type GetItemGameIndicesAggregateType<T extends ItemGameIndicesAggregateArgs> = {
      [P in keyof T & keyof AggregateItemGameIndices]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateItemGameIndices[P]>
    : Prisma.GetScalarType<T[P], AggregateItemGameIndices[P]>
}
...
export type GetItemGameIndicesGroupByPayload<T extends ItemGameIndicesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ItemGameIndicesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ItemGameIndicesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ItemGameIndicesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ItemGameIndicesGroupByOutputType[P]>
      }
    >
  >
...
export type ItemGameIndicesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ItemGameIndicesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ItemGameIndicesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ItemGameIndices'], meta: { name: 'ItemGameIndices' } }
  /**
   ...
   * })
  **/
  count<T extends ItemGameIndicesCountArgs>(
    args?: Prisma.Subset<T, ItemGameIndicesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ItemGameIndicesCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ItemGameIndicesGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ItemGameIndicesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetItemGameIndicesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
