...
// @ts-nocheck 
/*
 * This file exports the `ItemFlagMap` model and its related types.
 *
...
export type GetItemFlagMapAggregateType<T extends ItemFlagMapAggregateArgs> = {
      [P in keyof T & keyof AggregateItemFlagMap]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateItemFlagMap[P]>
    : Prisma.GetScalarType<T[P], AggregateItemFlagMap[P]>
}
...
export type GetItemFlagMapGroupByPayload<T extends ItemFlagMapGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ItemFlagMapGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ItemFlagMapGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ItemFlagMapGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ItemFlagMapGroupByOutputType[P]>
      }
    >
  >
...
export type ItemFlagMapCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ItemFlagMapFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ItemFlagMapDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ItemFlagMap'], meta: { name: 'ItemFlagMap' } }
  /**
   ...
   * })
  **/
  count<T extends ItemFlagMapCountArgs>(
    args?: Prisma.Subset<T, ItemFlagMapCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ItemFlagMapCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ItemFlagMapGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ItemFlagMapGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetItemFlagMapGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
