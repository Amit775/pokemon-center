...
// @ts-nocheck 
/*
 * This file exports the `LocationAreaEncounterRates` model and its related types.
 *
...
export type GetLocationAreaEncounterRatesAggregateType<T extends LocationAreaEncounterRatesAggregateArgs> = {
      [P in keyof T & keyof AggregateLocationAreaEncounterRates]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateLocationAreaEncounterRates[P]>
    : Prisma.GetScalarType<T[P], AggregateLocationAreaEncounterRates[P]>
}
...
export type GetLocationAreaEncounterRatesGroupByPayload<T extends LocationAreaEncounterRatesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<LocationAreaEncounterRatesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof LocationAreaEncounterRatesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], LocationAreaEncounterRatesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], LocationAreaEncounterRatesGroupByOutputType[P]>
      }
    >
  >
...
export type LocationAreaEncounterRatesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<LocationAreaEncounterRatesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface LocationAreaEncounterRatesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['LocationAreaEncounterRates'], meta: { name: 'LocationAreaEncounterRates' } }
  /**
   ...
   * })
  **/
  count<T extends LocationAreaEncounterRatesCountArgs>(
    args?: Prisma.Subset<T, LocationAreaEncounterRatesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], LocationAreaEncounterRatesCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends LocationAreaEncounterRatesGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, LocationAreaEncounterRatesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLocationAreaEncounterRatesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
