...
// @ts-nocheck 
/*
 * This file exports the `SuperContestCombos` model and its related types.
 *
...
export type GetSuperContestCombosAggregateType<T extends SuperContestCombosAggregateArgs> = {
      [P in keyof T & keyof AggregateSuperContestCombos]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateSuperContestCombos[P]>
    : Prisma.GetScalarType<T[P], AggregateSuperContestCombos[P]>
}
...
export type GetSuperContestCombosGroupByPayload<T extends SuperContestCombosGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<SuperContestCombosGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof SuperContestCombosGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], SuperContestCombosGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], SuperContestCombosGroupByOutputType[P]>
      }
    >
  >
...
export type SuperContestCombosCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<SuperContestCombosFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SuperContestCombosDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['SuperContestCombos'], meta: { name: 'SuperContestCombos' } }
  /**
   ...
   * })
  **/
  count<T extends SuperContestCombosCountArgs>(
    args?: Prisma.Subset<T, SuperContestCombosCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], SuperContestCombosCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends SuperContestCombosGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, SuperContestCombosGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSuperContestCombosGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
