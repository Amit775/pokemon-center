...
// @ts-nocheck 
/*
 * This file exports the `LocationGameIndices` model and its related types.
 *
...
export type GetLocationGameIndicesAggregateType<T extends LocationGameIndicesAggregateArgs> = {
      [P in keyof T & keyof AggregateLocationGameIndices]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateLocationGameIndices[P]>
    : Prisma.GetScalarType<T[P], AggregateLocationGameIndices[P]>
}
...
export type GetLocationGameIndicesGroupByPayload<T extends LocationGameIndicesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<LocationGameIndicesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof LocationGameIndicesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], LocationGameIndicesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], LocationGameIndicesGroupByOutputType[P]>
      }
    >
  >
...
export type LocationGameIndicesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<LocationGameIndicesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface LocationGameIndicesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['LocationGameIndices'], meta: { name: 'LocationGameIndices' } }
  /**
   ...
   * })
  **/
  count<T extends LocationGameIndicesCountArgs>(
    args?: Prisma.Subset<T, LocationGameIndicesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], LocationGameIndicesCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends LocationGameIndicesGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, LocationGameIndicesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetLocationGameIndicesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
