...
// @ts-nocheck 
/*
 * This file exports the `BerryFlavors` model and its related types.
 *
...
export type GetBerryFlavorsAggregateType<T extends BerryFlavorsAggregateArgs> = {
      [P in keyof T & keyof AggregateBerryFlavors]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBerryFlavors[P]>
    : Prisma.GetScalarType<T[P], AggregateBerryFlavors[P]>
}
...
export type GetBerryFlavorsGroupByPayload<T extends BerryFlavorsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BerryFlavorsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BerryFlavorsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BerryFlavorsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BerryFlavorsGroupByOutputType[P]>
      }
    >
  >
...
export type BerryFlavorsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BerryFlavorsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BerryFlavorsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['BerryFlavors'], meta: { name: 'BerryFlavors' } }
  /**
   ...
   * })
  **/
  count<T extends BerryFlavorsCountArgs>(
    args?: Prisma.Subset<T, BerryFlavorsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BerryFlavorsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends BerryFlavorsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, BerryFlavorsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBerryFlavorsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
