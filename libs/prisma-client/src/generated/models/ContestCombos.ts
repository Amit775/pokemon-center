...
// @ts-nocheck 
/*
 * This file exports the `ContestCombos` model and its related types.
 *
...
export type GetContestCombosAggregateType<T extends ContestCombosAggregateArgs> = {
      [P in keyof T & keyof AggregateContestCombos]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateContestCombos[P]>
    : Prisma.GetScalarType<T[P], AggregateContestCombos[P]>
}
...
export type GetContestCombosGroupByPayload<T extends ContestCombosGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ContestCombosGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ContestCombosGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ContestCombosGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ContestCombosGroupByOutputType[P]>
      }
    >
  >
...
export type ContestCombosWhereUniqueInput = Prisma.AtLeast<{
  first_move_id_second_move_id?: Prisma.ContestCombosFirst_move_idSecond_move_idCompoundUniqueInput
  AND?: Prisma.ContestCombosWhereInput | Prisma.ContestCombosWhereInput[]
  OR?: Prisma.ContestCombosWhereInput[]
  NOT?: Prisma.ContestCombosWhereInput | Prisma.ContestCombosWhereInput[]
  first_move_id?: Prisma.IntFilter<"ContestCombos"> | number
...
export type ContestCombosFirst_move_idSecond_move_idCompoundUniqueInput = {
  first_move_id: number
  second_move_id: number
}
...
export type ContestCombosCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ContestCombosFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ContestCombosDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ContestCombos'], meta: { name: 'ContestCombos' } }
  /**
   ...
   * })
  **/
  count<T extends ContestCombosCountArgs>(
    args?: Prisma.Subset<T, ContestCombosCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ContestCombosCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ContestCombosGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ContestCombosGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetContestCombosGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
