...
// @ts-nocheck 
/*
 * This file exports the `PokemonFormGenerations` model and its related types.
 *
...
export type GetPokemonFormGenerationsAggregateType<T extends PokemonFormGenerationsAggregateArgs> = {
      [P in keyof T & keyof AggregatePokemonFormGenerations]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePokemonFormGenerations[P]>
    : Prisma.GetScalarType<T[P], AggregatePokemonFormGenerations[P]>
}
...
export type GetPokemonFormGenerationsGroupByPayload<T extends PokemonFormGenerationsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PokemonFormGenerationsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PokemonFormGenerationsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PokemonFormGenerationsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PokemonFormGenerationsGroupByOutputType[P]>
      }
    >
  >
...
export type PokemonFormGenerationsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PokemonFormGenerationsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PokemonFormGenerationsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PokemonFormGenerations'], meta: { name: 'PokemonFormGenerations' } }
  /**
   ...
   * })
  **/
  count<T extends PokemonFormGenerationsCountArgs>(
    args?: Prisma.Subset<T, PokemonFormGenerationsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PokemonFormGenerationsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PokemonFormGenerationsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PokemonFormGenerationsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPokemonFormGenerationsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
