...
// @ts-nocheck 
/*
 * This file exports the `PokemonItems` model and its related types.
 *
...
export type GetPokemonItemsAggregateType<T extends PokemonItemsAggregateArgs> = {
      [P in keyof T & keyof AggregatePokemonItems]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePokemonItems[P]>
    : Prisma.GetScalarType<T[P], AggregatePokemonItems[P]>
}
...
export type GetPokemonItemsGroupByPayload<T extends PokemonItemsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PokemonItemsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PokemonItemsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PokemonItemsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PokemonItemsGroupByOutputType[P]>
      }
    >
  >
...
export type PokemonItemsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PokemonItemsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PokemonItemsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PokemonItems'], meta: { name: 'PokemonItems' } }
  /**
   ...
   * })
  **/
  count<T extends PokemonItemsCountArgs>(
    args?: Prisma.Subset<T, PokemonItemsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PokemonItemsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PokemonItemsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PokemonItemsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPokemonItemsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
