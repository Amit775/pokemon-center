...
// @ts-nocheck 
/*
 * This file exports the `PokemonEggGroups` model and its related types.
 *
...
export type GetPokemonEggGroupsAggregateType<T extends PokemonEggGroupsAggregateArgs> = {
      [P in keyof T & keyof AggregatePokemonEggGroups]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePokemonEggGroups[P]>
    : Prisma.GetScalarType<T[P], AggregatePokemonEggGroups[P]>
}
...
export type GetPokemonEggGroupsGroupByPayload<T extends PokemonEggGroupsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PokemonEggGroupsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PokemonEggGroupsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PokemonEggGroupsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PokemonEggGroupsGroupByOutputType[P]>
      }
    >
  >
...
export type PokemonEggGroupsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PokemonEggGroupsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PokemonEggGroupsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PokemonEggGroups'], meta: { name: 'PokemonEggGroups' } }
  /**
   ...
   * })
  **/
  count<T extends PokemonEggGroupsCountArgs>(
    args?: Prisma.Subset<T, PokemonEggGroupsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PokemonEggGroupsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PokemonEggGroupsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PokemonEggGroupsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPokemonEggGroupsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
