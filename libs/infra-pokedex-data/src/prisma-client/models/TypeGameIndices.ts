...
// @ts-nocheck 
/*
 * This file exports the `TypeGameIndices` model and its related types.
 *
...
export type GetTypeGameIndicesAggregateType<T extends TypeGameIndicesAggregateArgs> = {
      [P in keyof T & keyof AggregateTypeGameIndices]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateTypeGameIndices[P]>
    : Prisma.GetScalarType<T[P], AggregateTypeGameIndices[P]>
}
...
export type GetTypeGameIndicesGroupByPayload<T extends TypeGameIndicesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<TypeGameIndicesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof TypeGameIndicesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], TypeGameIndicesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], TypeGameIndicesGroupByOutputType[P]>
      }
    >
  >
...
export type TypeGameIndicesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<TypeGameIndicesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface TypeGameIndicesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['TypeGameIndices'], meta: { name: 'TypeGameIndices' } }
  /**
   ...
   * })
  **/
  count<T extends TypeGameIndicesCountArgs>(
    args?: Prisma.Subset<T, TypeGameIndicesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], TypeGameIndicesCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends TypeGameIndicesGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, TypeGameIndicesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetTypeGameIndicesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
