...
// @ts-nocheck 
/*
 * This file exports the `Berries` model and its related types.
 *
...
export type GetBerriesAggregateType<T extends BerriesAggregateArgs> = {
      [P in keyof T & keyof AggregateBerries]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateBerries[P]>
    : Prisma.GetScalarType<T[P], AggregateBerries[P]>
}
...
export type GetBerriesGroupByPayload<T extends BerriesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<BerriesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof BerriesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], BerriesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], BerriesGroupByOutputType[P]>
      }
    >
  >
...
export type BerriesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<BerriesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface BerriesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['Berries'], meta: { name: 'Berries' } }
  /**
   ...
   * })
  **/
  count<T extends BerriesCountArgs>(
    args?: Prisma.Subset<T, BerriesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], BerriesCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, BerriesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetBerriesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
