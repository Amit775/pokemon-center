...
// @ts-nocheck 
/*
 * This file exports the `PokemonAbilities` model and its related types.
 *
...
export type GetPokemonAbilitiesAggregateType<T extends PokemonAbilitiesAggregateArgs> = {
      [P in keyof T & keyof AggregatePokemonAbilities]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregatePokemonAbilities[P]>
    : Prisma.GetScalarType<T[P], AggregatePokemonAbilities[P]>
}
...
export type GetPokemonAbilitiesGroupByPayload<T extends PokemonAbilitiesGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<PokemonAbilitiesGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof PokemonAbilitiesGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], PokemonAbilitiesGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], PokemonAbilitiesGroupByOutputType[P]>
      }
    >
  >
...
export type PokemonAbilitiesCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<PokemonAbilitiesFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface PokemonAbilitiesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['PokemonAbilities'], meta: { name: 'PokemonAbilities' } }
  /**
   ...
   * })
  **/
  count<T extends PokemonAbilitiesCountArgs>(
    args?: Prisma.Subset<T, PokemonAbilitiesCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], PokemonAbilitiesCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends PokemonAbilitiesGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, PokemonAbilitiesGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetPokemonAbilitiesGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
