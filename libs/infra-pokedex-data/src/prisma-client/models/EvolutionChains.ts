...
// @ts-nocheck 
/*
 * This file exports the `EvolutionChains` model and its related types.
 *
...
export type GetEvolutionChainsAggregateType<T extends EvolutionChainsAggregateArgs> = {
      [P in keyof T & keyof AggregateEvolutionChains]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateEvolutionChains[P]>
    : Prisma.GetScalarType<T[P], AggregateEvolutionChains[P]>
}
...
export type GetEvolutionChainsGroupByPayload<T extends EvolutionChainsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<EvolutionChainsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof EvolutionChainsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], EvolutionChainsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], EvolutionChainsGroupByOutputType[P]>
      }
    >
  >
...
export type EvolutionChainsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<EvolutionChainsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface EvolutionChainsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['EvolutionChains'], meta: { name: 'EvolutionChains' } }
  /**
   ...
   * })
  **/
  count<T extends EvolutionChainsCountArgs>(
    args?: Prisma.Subset<T, EvolutionChainsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], EvolutionChainsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends EvolutionChainsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, EvolutionChainsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEvolutionChainsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
