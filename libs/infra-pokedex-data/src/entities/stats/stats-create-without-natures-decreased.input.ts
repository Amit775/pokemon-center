...
import { NaturesCreateNestedManyWithoutIncreasedStatInput } from '../natures/natures-create-nested-many-without-increased-stat.input';

@InputType()
export class StatsCreateWithoutNaturesDecreasedInput {
    ...
    pokemonStats?: PokemonStatsCreateNestedManyWithoutStatInput;
