...
@InputType()
export class LocationAreaEncounterRatesUncheckedUpdateManyWithoutVersionNestedInput {
    ...
    createMany?: LocationAreaEncounterRatesCreateManyVersionInputEnvelope;
