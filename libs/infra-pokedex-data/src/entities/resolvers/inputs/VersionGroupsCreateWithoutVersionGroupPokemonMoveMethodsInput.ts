...
import { GenerationsCreateNestedOneWithoutVersionGroupsInput } from "../inputs/GenerationsCreateNestedOneWithoutVersionGroupsInput";
...
@TypeGraphQL.InputType("VersionGroupsCreateWithoutVersionGroupPokemonMoveMethodsInput", {})
export class VersionGroupsCreateWithoutVersionGroupPokemonMoveMethodsInput {
  ...
  @TypeGraphQL.Field(_type => GenerationsCreateNestedOneWithoutVersionGroupsInput, {
    nullable: false
  })
