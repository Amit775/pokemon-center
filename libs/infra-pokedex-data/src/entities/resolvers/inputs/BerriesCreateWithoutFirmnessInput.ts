...
import { ItemsCreateNestedOneWithoutBerriesInput } from "../inputs/ItemsCreateNestedOneWithoutBerriesInput";
import { TypesCreateNestedOneWithoutNaturalGiftTypesInput } from "../inputs/TypesCreateNestedOneWithoutNaturalGiftTypesInput";

@TypeGraphQL.InputType("BerriesCreateWithoutFirmnessInput", {})
export class BerriesCreateWithoutFirmnessInput {
  ...
  @TypeGraphQL.Field(_type => ItemsCreateNestedOneWithoutBerriesInput, {
    nullable: false
  })
