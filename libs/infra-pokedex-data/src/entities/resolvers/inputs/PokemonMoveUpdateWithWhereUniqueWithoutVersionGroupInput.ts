...
@TypeGraphQL.InputType("PokemonMoveUpdateWithWhereUniqueWithoutVersionGroupInput", {})
export class PokemonMoveUpdateWithWhereUniqueWithoutVersionGroupInput {
  ...
  data!: PokemonMoveUpdateWithoutVersionGroupInput;
}
