...
@TypeGraphQL.InputType("ItemUpdateWithWhereUniqueWithoutFlingEffectInput", {})
export class ItemUpdateWithWhereUniqueWithoutFlingEffectInput {
  ...
  data!: ItemUpdateWithoutFlingEffectInput;
}
