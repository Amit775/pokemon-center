...
import { TypeCreateNestedManyWithoutNaturesIncreasedInput } from "../inputs/TypeCreateNestedManyWithoutNaturesIncreasedInput";
import { TypeCreateNestedManyWithoutNaturesInput } from "../inputs/TypeCreateNestedManyWithoutNaturesInput";

@TypeGraphQL.InputType("NatureCreateWithoutBattleStylePreferencesInput", {})
export class NatureCreateWithoutBattleStylePreferencesInput {
  ...
  @TypeGraphQL.Field(_type => TypeCreateNestedManyWithoutNaturesIncreasedInput, {
    nullable: true
  })
  increasedStatTypes?: TypeCreateNestedManyWithoutNaturesIncreasedInput | undefined;
}
