...
@TypeGraphQL.InputType("PokemonEggGroupOrderByWithRelationInput", {})
export class PokemonEggGroupOrderByWithRelationInput {
  ...
  eggGroup?: EggGroupOrderByWithRelationInput | undefined;
}
