...
@TypeGraphQL.InputType("ContestTypeUpdateToOneWithWhereWithoutMovesInput", {})
export class ContestTypeUpdateToOneWithWhereWithoutMovesInput {
  ...
  data!: ContestTypeUpdateWithoutMovesInput;
}
