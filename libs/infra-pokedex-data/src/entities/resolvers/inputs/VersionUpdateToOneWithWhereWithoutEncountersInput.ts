...
@TypeGraphQL.InputType("VersionUpdateToOneWithWhereWithoutEncountersInput", {})
export class VersionUpdateToOneWithWhereWithoutEncountersInput {
  ...
  data!: VersionUpdateWithoutEncountersInput;
}
