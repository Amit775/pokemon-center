...
import { PokemonUpdateToOneWithWhereWithoutTypesInput } from "../inputs/PokemonUpdateToOneWithWhereWithoutTypesInput";
import { PokemonUpsertWithoutTypesInput } from "../inputs/PokemonUpsertWithoutTypesInput";
import { PokemonWhereUniqueInput } from "../inputs/PokemonWhereUniqueInput";

@TypeGraphQL.InputType("PokemonUpdateOneRequiredWithoutTypesNestedInput", {})
export class PokemonUpdateOneRequiredWithoutTypesNestedInput {
  ...
  @TypeGraphQL.Field(_type => PokemonUpsertWithoutTypesInput, {
    nullable: true
  })
  upsert?: PokemonUpsertWithoutTypesInput | undefined;
  ...
  @TypeGraphQL.Field(_type => PokemonUpdateToOneWithWhereWithoutTypesInput, {
    nullable: true
  })
  update?: PokemonUpdateToOneWithWhereWithoutTypesInput | undefined;
}
