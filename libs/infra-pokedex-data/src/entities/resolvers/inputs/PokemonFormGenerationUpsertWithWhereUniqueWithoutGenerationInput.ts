...
@TypeGraphQL.InputType("PokemonFormGenerationUpsertWithWhereUniqueWithoutGenerationInput", {})
export class PokemonFormGenerationUpsertWithWhereUniqueWithoutGenerationInput {
  ...
  update!: PokemonFormGenerationUpdateWithoutGenerationInput;
