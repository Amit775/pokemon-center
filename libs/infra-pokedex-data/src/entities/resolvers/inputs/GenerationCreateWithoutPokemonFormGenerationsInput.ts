...
import { MoveCreateNestedManyWithoutGenerationInput } from "../inputs/MoveCreateNestedManyWithoutGenerationInput";
...
@TypeGraphQL.InputType("GenerationCreateWithoutPokemonFormGenerationsInput", {})
export class GenerationCreateWithoutPokemonFormGenerationsInput {
  ...
  @TypeGraphQL.Field(_type => MoveCreateNestedManyWithoutGenerationInput, {
    nullable: true
  })
  moves?: MoveCreateNestedManyWithoutGenerationInput | undefined;
