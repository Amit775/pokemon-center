...
import { MoveEffectsCreateNestedOneWithoutMovesInput } from "../inputs/MoveEffectsCreateNestedOneWithoutMovesInput";
...
@TypeGraphQL.InputType("MovesCreateWithoutSuperContestCombosSecondInput", {})
export class MovesCreateWithoutSuperContestCombosSecondInput {
  ...
  @TypeGraphQL.Field(_type => MoveEffectsCreateNestedOneWithoutMovesInput, {
    nullable: true
  })
  effect?: MoveEffectsCreateNestedOneWithoutMovesInput | undefined;
