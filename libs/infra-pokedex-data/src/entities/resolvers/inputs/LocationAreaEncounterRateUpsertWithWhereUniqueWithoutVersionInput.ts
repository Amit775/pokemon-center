...
@TypeGraphQL.InputType("LocationAreaEncounterRateUpsertWithWhereUniqueWithoutVersionInput", {})
export class LocationAreaEncounterRateUpsertWithWhereUniqueWithoutVersionInput {
  ...
  update!: LocationAreaEncounterRateUpdateWithoutVersionInput;
