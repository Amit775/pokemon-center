...
import { MachineCreateNestedManyWithoutItemInput } from "../inputs/MachineCreateNestedManyWithoutItemInput";
...
@TypeGraphQL.InputType("ItemCreateWithoutBabyTriggerItemsInput", {})
export class ItemCreateWithoutBabyTriggerItemsInput {
  ...
  @TypeGraphQL.Field(_type => MachineCreateNestedManyWithoutItemInput, {
    nullable: true
  })
  machines?: MachineCreateNestedManyWithoutItemInput | undefined;
