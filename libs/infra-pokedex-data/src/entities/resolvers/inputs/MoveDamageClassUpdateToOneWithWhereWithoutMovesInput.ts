...
@TypeGraphQL.InputType("MoveDamageClassUpdateToOneWithWhereWithoutMovesInput", {})
export class MoveDamageClassUpdateToOneWithWhereWithoutMovesInput {
  ...
  data!: MoveDamageClassUpdateWithoutMovesInput;
}
