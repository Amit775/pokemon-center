...
import { MoveCreateNestedManyWithoutTypeInput } from "../inputs/MoveCreateNestedManyWithoutTypeInput";
...
@TypeGraphQL.InputType("TypeCreateWithoutNaturalGiftTypesInput", {})
export class TypeCreateWithoutNaturalGiftTypesInput {
  ...
  @TypeGraphQL.Field(_type => MoveCreateNestedManyWithoutTypeInput, {
    nullable: true
  })
  moves?: MoveCreateNestedManyWithoutTypeInput | undefined;
