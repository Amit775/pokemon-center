...
export class CreateManyAndReturnMoveMeta {
  ...
  @TypeGraphQL.Field(_type => MoveMetaCategory, {
    nullable: false
  })
  ...
  @TypeGraphQL.Field(_type => MoveMetaAilment, {
    name: "metaAilment",
    nullable: true
  })
  getMetaAilment(@TypeGraphQL.Root() root: CreateManyAndReturnMoveMeta, @TypeGraphQL.Args() args: CreateManyAndReturnMoveMetaMetaAilmentArgs): MoveMetaAilment | null {
