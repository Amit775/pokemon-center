...
export class CreateManyAndReturnPokemonSpecies {
  ...
  @TypeGraphQL.Field(_type => EvolutionChains, {
    nullable: false
  })
  evolutionChain!: EvolutionChains;

  @TypeGraphQL.Field(_type => PokemonColors, {
    nullable: false
  })
  color!: PokemonColors;

  @TypeGraphQL.Field(_type => PokemonShapes, {
    nullable: false
  })
  shape!: PokemonShapes;
  ...
  @TypeGraphQL.Field(_type => PokemonHabitats, {
    name: "habitat",
    nullable: true
  })
  getHabitat(@TypeGraphQL.Root() root: CreateManyAndReturnPokemonSpecies, @TypeGraphQL.Args() args: CreateManyAndReturnPokemonSpeciesHabitatArgs): PokemonHabitats | null {
    return root.habitat;
  }
}
